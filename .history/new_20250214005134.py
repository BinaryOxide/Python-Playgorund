...
try:
    background_image = tk.PhotoImage(file="background.png")  # Replace with your image path
...
# Add a semi-transparent black rectangle to darken the background (simulate blur)
canvas.create_rectangle(0, 0, 800, 400, fill="black", stipple="gray25")  # Adjust stipple for transparency
