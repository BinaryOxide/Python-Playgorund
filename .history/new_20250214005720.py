...
try:
    background_image = tk.PhotoImage(file=r"G:\personalization\wallpaper\AESTHETIC\ff9235cd827885e439aef1bb9e153754_upscayl_3x_realesrgan-x4plus.png")  # Replace with your image path
...
clock_label = tk.Label(
    ...
    bg='black',                                  # Set background color to match the canvas
)
